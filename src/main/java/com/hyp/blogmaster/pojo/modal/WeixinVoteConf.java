...
public class WeixinVoteConf {
    ...
    public enum ActiveConfRepeatVoteEnum {

        CAN_REPEAT_VOTE(1, "允许重复投票"),
        CAN_NOT_REPEAT_VOTE(0, "不允许重复投票");
        ...
        ActiveConfRepeatVoteEnum(Integer code, String msg) {
            this.code = code;
            this.msg = msg;
        }
        ...
        public String toString() {
            return "ActiveConfRepeatVoteEnum{" +
                    "code=" + code +
                    ", msg='" + msg + '\'' +
                    '}';
        }
    ...
    public enum ActiveConfNeedPhoneEnum {
        ...
        public static String getEnumMsg(Integer code) {
            for (ActiveConfNeedPhoneEnum receiveEmailHasDeleteEnum : ActiveConfNeedPhoneEnum.values()) {
