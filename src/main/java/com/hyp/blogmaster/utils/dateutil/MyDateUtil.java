...
public class MyDateUtil {
     ...
     * 如果要计算分钟数
     *
     * @param startTime 前面的时间
     * @param endTime   后面的时间
     * @param type      类型  0：秒数，1：分钟数，2：小时数，3：天数
     * @return 返回的是毫秒数
     */
    public static float getDistanceTimeByType(long startTime, long endTime, int type) {
        ...
        switch (type) {
            case 0:
                /*分钟数*/
                distanceTime = (float) diff / 1000;
                break;
            case 1:
                /*分钟数*/
                distanceTime = (float) diff / 1000 / 60;
                break;
            case 2:
                /*小时数*/
                distanceTime = (float) diff / 1000 / 60 / 60;
                break;
            case 3:
                /*天数*/
                distanceTime = (float) diff / 1000 / 60 / 60 / 24;
                break;
            default:
                distanceTime = -1f;
                break;
     ...
     * @return 返回的是指定格式的字符串
     */
    public static String numberDateFormat(String timestamp, String pattern) {
        //要转换的时间格式
     ...
     * @return 简单农历对象
     */
    public static com.hyp.blogmaster.utils.dateutil.SimpleLunarCalendar getSimpleLunarCalendar(String date) {
        return new com.hyp.blogmaster.utils.dateutil.SimpleLunarCalendar(MyDateUtil.StringToDate(date));
    }
     ...
     * @return 简单农历对象
     */
    public static com.hyp.blogmaster.utils.dateutil.SimpleLunarCalendar getSimpleLunarCalendar(Date date) {
        return new com.hyp.blogmaster.utils.dateutil.SimpleLunarCalendar(date);
    }
